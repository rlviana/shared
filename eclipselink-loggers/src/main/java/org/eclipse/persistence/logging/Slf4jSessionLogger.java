 ...
 * </p>
 * <p>
 * Use the following configuration for using SLF4J with EclipseLink <code>eclipselink.logging.logger</code> and the
 * value <code>org.eclipse.persistence.logging.Slf4jSessionLogger</code>
 * </p>
 * <p>
 * Use the following categories from EclipseLink (eclipselink.logging.timestamp, eclipselink.logging.thread,
 * eclipselink.logging.session, eclipselink.logging.connection y eclipselink.logging.parameters).
 * <p>
