...
public final class CommonsLoggingSessionLog extends AbstractSessionLog {
   ...
   */
  public static final String LOGGING_LOCALIZATION_STRING =
      "org.eclipse.persistence.internal.localization.i18n.LoggingLocalizationResource";
  /**
   * Copied from JavaLog for compatibility issues
   */
  public static final String TRACE_LOCALIZATION_STRING =
  ...
  public static final void onInit() {
    ...
    if (FORCE_APACHE_COMMONS_LOGGING_DIAGNOSTICS) {
       ...
       * <p>
       * Diagnostic logging should be used only to debug problematic configurations and should not be set in normal
       * production use.
       */
      ...
      if (lw != null) {
        ...
        if (logger == null) {
          ...
          if (FORCE_INTERNAL_DEBUG) {
            System.out.println(
                "CommonsLoggingSessionLog.LogWrapper.computeLevel : category : " + lw.getCategory()
                    + " :  realLevel : " + realLevel + " - enabled = " + enabled);
          }
        }
